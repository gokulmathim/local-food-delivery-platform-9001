 ...
 *
 * Props:
 *   - size: (number) default 80. Width and height in px.
 *   - style: (object) inject CSS style overrides.
 */
export default function OnlineFoodLogo({ size = 80, style }) {
  return (
    <svg
      width={size}
      height={Math.round((size * 1.04))} // Keep vertical proportions (base ~80x83)
      viewBox="0 0 80 83"
      fill="none"
      style={style}
